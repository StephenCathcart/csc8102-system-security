...
public class Launcher {
    ...
    /**
     * Applications main method. Takes a file containing a list of hashed
     * passwords and outputs a new file containing the broken hashes. Any errors
     * will be printed to console. If the options supplied are invalid print
     * help to the console.
     *
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (clo.hasOption('i') && clo.hasOption('o') && clo.hasOption('d')) {
                ...
                recover.crack(
                    FileUtil.create(clo.getOptionValue('i'), false, false),
